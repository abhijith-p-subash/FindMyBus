...
- `https://bus.trackingo.in/customer/track_vehicle?YE0407` — bare query string, or `?key=`
- `http://trkg.in/BITLAA/YAV2LH` — last path segment
- `YE0407` — bare 4–10 alphanumeric code
